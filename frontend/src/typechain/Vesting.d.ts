...
interface VestingInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setUsers(address[],uint128[])": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "boughtNFTs", data: BytesLike): Result;
  ...
  events: {
    ...
    "UserDataSet(address,uint256)": EventFragment;
...
export type UserDataSetEvent = TypedEvent<
  [string, BigNumber] & { user: string; vestedNFTs: BigNumber }
>;
...
export class Vesting extends BaseContract {
  ...
  functions: {
    boughtNFTs(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    "UserDataSet(address,uint256)"(
      user?: null,
      vestedNFTs?: null
    ): TypedEventFilter<
      [string, BigNumber],
      { user: string; vestedNFTs: BigNumber }
    >;
  ...
  populateTransaction: {
    boughtNFTs(overrides?: CallOverrides): Promise<PopulatedTransaction>;
